...
def _generate_mesh_from_xy(
    ...
    row_dln = np.delete(row_dln, tuple(deleted_catchment))
    col_dln = np.delete(col_dln, tuple(deleted_catchment))
    area_dln = np.delete(area_dln, tuple(deleted_catchment))
    area = np.delete(area, tuple(deleted_catchment))
    code = np.delete(code, tuple(deleted_catchment))
    x = np.delete(x, tuple(deleted_catchment))
    y = np.delete(y, tuple(deleted_catchment))
...
>>>>>>> exclude_mesh_outlets_based_on_surface_error
